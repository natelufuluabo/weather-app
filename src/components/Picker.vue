<template>
    <div class="div1">
        ...
        <ion-item>
          <ion-select label="City" :value="userChoice.location" 
            @ionChange="event => handleChange(event, userChoice, cityCoordinates, location)" placeholder="Pick">
...
import { cityCoordinates, location, userChoice } from '../store.js';
